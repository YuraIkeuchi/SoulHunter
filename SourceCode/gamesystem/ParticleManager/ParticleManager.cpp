...
void ParticleManager::CreateCommon(ID3D12Device* dev, ID3D12GraphicsCommandList* cmdList, const std::string& directoryPath) {
	//nullptrチェック
	assert(dev);
	assert(cmdList);

	ParticleManager::device = dev;
...
void ParticleManager::Draw(int type) {
